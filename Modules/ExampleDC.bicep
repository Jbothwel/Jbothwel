...
resource domainServicesNSGName 'Microsoft.Network/networkSecurityGroups@2020-11-01' = {
...
resource domainServicesVnetName_resource 'Microsoft.Network/virtualNetworks@2020-11-01' = {
...
resource domainServicesVnetName_domainServicesSubnetName 'Microsoft.Network/virtualNetworks/subnets@2020-11-01' = {
  parent: domainServicesVnetName_resource
  name: '${domainServicesSubnetName}'
  properties: {
    addressPrefix: domainServicesSubnetAddressPrefix
    networkSecurityGroup: {
      id: domainServicesNSGName.id
    }
  }
}
...
resource domainName_resource 'Microsoft.AAD/domainServices@2020-01-01' = {
  ...
  properties: {
    ...
    replicaSets: [
      {
        subnetId: domainServicesVnetName_domainServicesSubnetName.id
        location: location
      }
    ]
    sku: sku
